...
MSG="${1:-Add: Os Nove Desconhecidos Caps 01–02 — 8 entradas (conselho-dos-nove, eneada-egipcia, nove-desconhecidos, andrija-puharich, saint-yves-dalveydre, schwaller-de-lubicz, ashoka, j-j-hurtak), fontes 119–120, trilha nove-ocultos — 481 entradas, 120 fontes, 30 jornadas}"
